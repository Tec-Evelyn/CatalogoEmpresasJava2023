...
public class ContactoServlet extends HttpServlet {
    ...
    private Contacto obtenerContacto(HttpServletRequest request) {
        ...
        contacto.setNombre(Utilidad.getParameter(request, "nombre", ""));//si no encuentra el parametro queda vacio
    ...
    private void doPostRequestCreate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (result != 0) {//si recibimos un valor que no es cero significa que tubimos exito
                request.setAttribute("accion", "index");
                doGetRequestIndex(request, response);//metodo que rellena la lista con 10 registros
            } else {
    ...
    private void requestObtenerPorId(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (contacto_result.getId() > 0) {//si encontramos el registro
    ...
    private void doGetRequestEdit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {//metodo que ejecuta el metodo obtener por Id
    ...
    private void doPostRequestEdit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (result != 0) {
                request.setAttribute("accion", "index");
                doGetRequestIndex(request, response);//metodo que llena la tabla con 10 registros
            } else {
        ...
        SessionUser.authorize(request, response, () -> {
            ...
            switch (accion) {
                ...
                case "edit":
                    ...
                    break;
                case "delete"://si la accion es delete establecemos el atributo llamado accion con el valor delete
                    request.setAttribute("accion", accion);
                    doGetRequestDelete(request, response);//y llamamos el metodo doGetRequestDelete
                    break;
                case "details":
                    request.setAttribute("accion", accion);
        ...
        SessionUser.authorize(request, response, () -> {
            ...
            switch (accion) {
                ...
                case "delete":
                    ...
                    break;
                default://en cualquier ortro caso establecemos un atributo llamado accion con el valor predeterminado Index
                    request.setAttribute("accion", accion);
                    doGetRequestIndex(request, response);//y llamamos el metodo deGetRequestIndex
            }
        });
    }
// </editor-fold>
